                    ...
                    <Grid container spacing={3}>
                        <Grid item xs={12} sm={12}>
                            <FormikCustomInputBlur
                                ...
                                errors={errors.username}
                                startAdornment={
                                    <div style={{ width: "40px", paddingRight: "12px", marginRight: "12px", borderRight: `2px solid ${theme.palette.grey[300]}` }}>
                                        <IconUser color={theme.palette.text.secondary} />
                                    </div>
                                }
                            />
                        ...
                        <Grid item xs={12} sm={12}>
                            <FormikCustomInputBlur
                                ...
                                errors={errors.password}
                                endAdornment={
                                    <IconButton style={{ width: "40px", paddingRight: "12px" }} onClick={handleClickShowPassword}>
